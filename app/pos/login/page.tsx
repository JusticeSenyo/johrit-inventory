      ...
      <div className="w-full max-w-md">
        <div className="space-y-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-foreground">POS Login</h1>
          ...
          <form onSubmit={handleSubmit} className="bg-card rounded-lg border border-border p-8 space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-input border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-green-600"
                required
              />
            </div>
            ...
            <Button type="submit" disabled={isLoading} className="w-full bg-green-600 hover:bg-green-700" size="lg">
              {isLoading ? "Signing in..." : "POS Sign In"}
            </Button>
          </form>
